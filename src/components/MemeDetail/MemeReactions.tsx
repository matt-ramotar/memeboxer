    ...
    useEffect(() => {
        if (reactions) {
            ...
            for (const reaction of reactions) {
                ...
                if (userIdToMemeReactionIdsMap[reaction.userId]) {
                    if (userIdToMemeReactionIdsMap[reaction.userId][reaction.reactionId]) {
                        userIdToMemeReactionIdsMap[reaction.userId][reaction.reactionId].push(reaction.id);
                    } else {
                        userIdToMemeReactionIdsMap[reaction.userId][reaction.reactionId] = [reaction.id];
                    }
                } else {
                    userIdToMemeReactionIdsMap[reaction.userId] = {
