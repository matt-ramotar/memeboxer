...
export default function ChildCommentReactions(props: Props): JSX.Element | null {
  const commentReactions = useSelector((state: RootState) => state.comment.childrenReactions[props.comment.id]);
