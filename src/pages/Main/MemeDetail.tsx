            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Grid
                            container
                            style={{ height: "100%", width: "100%", overflowY: "scroll", display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: 8, paddingTop: 16 }}
                        >
                        ...
                        <Box style={{ width: "100%" }}>
                            ...
                            >
                                ...
                                <button style={{ backgroundColor: "transparent", border: "none", boxShadow: "none", padding: 0, margin: 0 }} disabled={isDisabled} onClick={onComment}>
                                    <Typography
                                        style={{ fontFamily: "Space Grotesk", fontWeight: "bold", cursor: "pointer", color: isDisabled ? "rgba(1, 96, 254, 0.4)" : theme.palette.primary.main }}
                                    >
                                        Comment
                                    </Typography>
                                </button>
